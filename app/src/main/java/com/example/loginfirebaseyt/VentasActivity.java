        ...
        btnBuscar.setOnClickListener(v -> {
            ...
            db.child(codigo).get().addOnSuccessListener(snapshot -> {
                if (snapshot.exists()) {
                    ...
                    tvPrecio.setText(String.valueOf(snapshot.child("precioVenta").getValue(Double.class)));
                } else {
            ...
            db.child(codigo).get().addOnSuccessListener(snapshot -> {
                if (snapshot.exists()) {
                    ...
                    if (cantidad <= stockActual) {
                        double precio = snapshot.child("precioVenta").getValue(Double.class);
